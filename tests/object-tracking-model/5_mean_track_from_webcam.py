...
# python 3_mean_track_from_webcam.py -m ssd_mobilenet_v2_320x320_coco17_tpu-8/saved_model -l data/mscoco_label_map.pbtxt --valid-classes 1
# python 3_mean_track_from_webcam.py -m ssd_mobilenet_v2_320x320_coco17_tpu-8/saved_model -l data/mscoco_label_map.pbtxt --valid-classes 1 <drone_class_id>
